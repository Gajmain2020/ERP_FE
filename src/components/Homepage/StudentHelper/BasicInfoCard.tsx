...
const BasicInfo = ({ details }: { details: StudentData | null }) => {
  ...
  return (
    <div className="border rounded-lg bg-gradient-to-br from-white to-gray-100 shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
      {details ? (
            ...
            <div className="grid grid-cols-2 gap-4 text-left text-gray-700">
              ...
              <div>
                ...
                <span className="text-gray-600">
                  {details.TG?.teacherId
                    ? details.TG.teacherName
                    : "TG not assigned"}
                </span>
              </div>
            </div>
        ...
        <div className="text-center text-xl p-6 text-gray-800 animate-pulse">
          Loading...
        </div>
      )}
    </div>
